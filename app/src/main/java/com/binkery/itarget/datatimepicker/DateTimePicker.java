package com.binkery.itarget.datatimepicker;
...
public class DateTimePicker implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public DateTimePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public DateTimePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.dialog_date_time_picker);
